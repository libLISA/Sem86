...
#[derive(Clone, PartialEq, Eq, Hash, PartialOrd, Ord, arbitrary::Arbitrary, bitcode::Encode, bitcode::Decode)]
...
#[expect(unused)]
struct FixedBitmapU64Schema {
    data: &'static [u64],
}

#[cfg(feature = "schemars")]
impl<const N: usize> schemars::JsonSchema for FixedBitmapU64<N> {
    fn schema_name() -> String {
        String::from("FixedBitmapU64")
    }

    fn json_schema(random: &mut schemars::r#gen::SchemaGenerator) -> schemars::schema::Schema {
        FixedBitmapU64Schema::json_schema(random)
    }

    fn is_referenceable() -> bool {
        FixedBitmapU64Schema::is_referenceable()
    }

    fn schema_id() -> std::borrow::Cow<'static, str> {
        FixedBitmapU64Schema::schema_id()
    }
}
